 ...
 *
 * Inherits all JdbcToStorageOptions (driverJars, driverClassName, connectionUrl,
 * username, password, KMSEncryptionKey, etc.) and adds:
 *
...
public interface JdbcToStorageBatchedOptions extends JdbcToStorageOptions {
  ...
  @Description(
      "JSON array of table configs. Example:\n"
          + "[\n"
  ...
  @Description(
      "Max number of tables to process in parallel (advisory only). "
